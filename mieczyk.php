...
?>
                            ...
                            <div id="rodzaj">
                                <p>Rodzaj</p>
                                    ...
                                    <div class="kolor-rodzaj">
                                        <button class="orange" onclick="currentSlide(1)"></button>
                                            <button class="black" onclick="currentSlide(2)"></button>
                                            <button class="green" onclick="currentSlide(3)"></button>
                                    </div>
                                <br>
                        <div id="ilosc">
                            <p>Ilosc</p>
                ...
                <div class="opis">
                    ...
                    <div class="opis1">
                        <p>Na sprzedaż mam samce o długości około 5cm. Nie powinno sie ich trzymać samców bez samicy. Mogą być agresywne do siebie i innych mieszkańców akwarium.</p>
                    </div>
                    <div class="opis2">
                        <table class="tabelka">
                            <tr>
